...
class StaticMaterialRepository : MaterialRepository {
    ...
    private val brickDB = mapOf(
        ...
        BrickType.COMUN to BrickProps(
            ...
            name = BrickType.COMUN.brickNameRes,
            width = 0.12,
            height = 0.05,
            length = 0.25,
        ...
        BrickType.LADRILLON to BrickProps(
            ...
            name = BrickType.LADRILLON.brickNameRes,
            width = 0.18,
            height = 0.07,
            length = 0.29,
            gasketThickness = 0.02,
        ...
        BrickType.HUECO_8 to BrickProps(
            ...
            name = BrickType.HUECO_8.brickNameRes,
            width = 0.08,
            height = 0.18,
            length = 0.33,
        ...
        BrickType.HUECO_12 to BrickProps(
            ...
            name = BrickType.HUECO_12.brickNameRes,
            width = 0.12,
            height = 0.18,
            length = 0.33,
            gasketThickness = 0.015,
        ...
        BrickType.HUECO_18 to BrickProps(
            ...
            name = BrickType.HUECO_18.brickNameRes,
            width = 0.18,
            height = 0.18,
            length = 0.33,
            gasketThickness = 0.015,
        ...
        BrickType.PORTANTE_12 to BrickProps(
            ...
            name = BrickType.PORTANTE_12.brickNameRes,
            width = 0.12,
            height = 0.19,
            length = 0.33,
            gasketThickness = 0.015,
        ...
        BrickType.PORTANTE_18 to BrickProps(
            ...
            name = BrickType.PORTANTE_18.brickNameRes,
            width = 0.18,
            height = 0.19,
            length = 0.33,
            gasketThickness = 0.015,
        ...
        BrickType.BLOQUE_10 to BrickProps(
            ...
            name = BrickType.BLOQUE_10.brickNameRes,
            width = 0.1,
            height = 0.19,
            length = 0.39,
        ...
        BrickType.BLOQUE_13 to BrickProps(
            ...
            name = BrickType.BLOQUE_13.brickNameRes,
            width = 0.13,
            height = 0.19,
            length = 0.39,
            gasketThickness = 0.01,
        ...
        BrickType.BLOQUE_15 to BrickProps(
            ...
            name = BrickType.BLOQUE_15.brickNameRes,
            width = 0.15,
            height = 0.19,
            length = 0.39,
            gasketThickness = 0.01,
        ...
        BrickType.BLOQUE_20 to BrickProps(
            ...
            name = BrickType.BLOQUE_20.brickNameRes,
            width = 0.2,
            height = 0.19,
            length = 0.39,
            gasketThickness = 0.01,
